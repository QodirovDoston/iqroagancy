...
$(document).ready(function() {
    $('.modal-1').click(function(event) {
        $('.modal__content-1').css('visibility', 'visible'),
        $('.modal__content-1').css('opacity', '1'),
        $('body').addClass('outwindow-black')
    }),
    $('.cancel').click(function(event) {
      $('.modal__content-1').css('visibility', 'hidden'),
      $('.modal__content-1').css('opacity', '0'),
      $('body').removeClass('outwindow-black')
    }),
    $('.modal-2').click(function(event) {
      $('.modal__content-2').css('visibility', 'visible'),
      $('.modal__content-2').css('opacity', '1'),
      $('body').addClass('outwindow-black')
    }),
    $('.cancel').click(function(event) {
      $('.modal__content-2').css('visibility', 'hidden'),
      $('.modal__content-2').css('opacity', '0'),
      $('body').removeClass('outwindow-black')
    })
    $('.modal-3').click(function(event) {
      $('.modal__content-3').css('visibility', 'visible'),
      $('.modal__content-3').css('opacity', '1'),
      $('body').addClass('outwindow-black')
  }),
    $('.cancel').click(function(event) {
      $('.modal__content-3').css('visibility', 'hidden'),
      $('.modal__content-3').css('opacity', '0'),
      $('body').removeClass('outwindow-black')
    }),
    $('.modal-4').click(function(event) {
      $('.modal__content-4').css('visibility', 'visible'),
      $('.modal__content-4').css('opacity', '1'),
      $('body').addClass('outwindow-black')
  }),
    $('.cancel').click(function(event) {
      $('.modal__content-4').css('visibility', 'hidden'),
      $('.modal__content-4').css('opacity', '0'),
      $('body').removeClass('outwindow-black')
    }),
    $('.modal-5').click(function(event) {
      $('.modal__content-5').css('visibility', 'visible'),
      $('.modal__content-5').css('opacity', '1'),
      $('body').addClass('outwindow-black')
  }),
    $('.cancel').click(function(event) {
      $('.modal__content-5').css('visibility', 'hidden'),
      $('.modal__content-5').css('opacity', '0'),
      $('body').removeClass('outwindow-black')
    }),
    $('.modal-6').click(function(event) {
        $('.modal__content-6').css('visibility', 'visible'),
        $('.modal__content-6').css('opacity', '1'),
        $('body').addClass('outwindow-black')
}),
$('.cancel').click(function(event) {
    $('.modal__content-6').css('visibility', 'hidden'),
    $('.modal__content-6').css('opacity', '0'),
    $('body').removeClass('outwindow-black')
  })
  $('.modal-7').click(function(event) {
    $('.modal__content-7').css('visibility', 'visible'),
    $('.modal__content-7').css('opacity', '1'),
    $('body').addClass('outwindow-black')
})
});